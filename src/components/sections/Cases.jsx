...
const cases = [
  {
    ...
    image: '/images/case-anna.jpg',
    imageAlt: 'Анна, 42 года, клиентка наставничества',
    problem:
  ...
  },
  {
    ...
    image: '/images/case-elena.jpg',
    imageAlt: 'Елена, 38 лет, клиентка наставничества',
    problem:
  ...
  },
  {
    ...
    image: '/images/case-olga.jpg',
    imageAlt: 'Ольга, 52 года, клиентка наставничества',
    problem:
          ...
          {cases.map((c, i) => (
            <Reveal key={c.name} delay={0.08 * i}>
              <article className="flex h-full flex-col gap-4 rounded-2xl bg-white p-6">
                <Photo src={c.image} alt={c.imageAlt} ratio="4 / 5" />
